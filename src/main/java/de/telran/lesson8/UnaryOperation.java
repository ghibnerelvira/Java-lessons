...
public class UnaryOperation {
    public static void main(String[] args) {
        ...
        // он используется для уменьшения значения целого числа.
        // Его можно использовать двумя отдельными способами:
        // Оператор постдекремента: При размещении после имени
        // переменной значение операнда уменьшается, но предыдущие
        // значения временно сохраняются до выполнения этого оператора
        // и обновляются перед выполнением следующего оператора.
